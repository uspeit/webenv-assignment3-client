<template>
    <v-app id="inspire"
           :style="{'background-image':'url(https://cdn.dribbble.com/users/1758067/screenshots/6307098/morocco_pattern_dribbble_bw_pattern_copy_4x.jpg?compress=1&resize=800x600)'}">
        <v-app-bar app clipped-left color="primary" dense>
            ...
            <div v-if="isLoggedIn">
                ...
                <transition name="fade-in">
                    <span>
                        <span class="mx-4 mt-1">Hello {{currentUser.fullname}}</span>
